...
/*
  ESTANTE
  Controle do acervo, empéstimos e usuários em uma pequena biblioteca.
  versão 0.1a

  Consultas (módulo)

  Copyright (C) 2005-2016  Giovanni Nunes <bitatwork@yahoo.com>
...
*/
  ...
  switch( $MI_LETR )
  {
    ...
    */
    ...
    /*
    primeira encarna��o do m�dulo, apenas uma lista simples
    */
    print "<p>Vers&atilde;o preliminar</p>\n";
    ...
    */
    ...
    /*
    a totaliza��o � bastante repetitiva, assim al�m de mais simples para
    os olhos ficou, tamb�m, mais elegante.
    */
    $RE_SQLS=array("",
    ...
    /*
      alguns valores s�o calculados e ficam por �ltimo
    */
    ...
    */
    ...
    /*
    os 10 usuarios mais ativos (eu sei que o termo � horr�vel)
    */
    print "<td colspan='4'>".
